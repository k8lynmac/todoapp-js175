...
module.exports = class SessionPersistence {
  constructor(session) {
    this._todoLists = session.todoLists || deepCopy(SeedData); //refers to session store or deep copy of seed data
  ...
  completeAll(todoListId) {
    ...
    undone.forEach(todo => this.toggleDoneTodo(todoListId, todo.id));
    return true;
  }
